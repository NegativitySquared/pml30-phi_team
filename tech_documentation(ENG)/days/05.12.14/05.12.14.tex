...
\begin{enumerate}
	...
	\begin{enumerate}
	  ...
	  \item We improved the program of autonomous period. Removed function that converted reading of encoder to centimeters. This increased the speed of the program and allowed the robot to accurately turn around and return to the parking zone.	  
